"""
:testcase_name flyweight
:source https://github.com/faif/python-patterns/blob/master/patterns/structural/flyweight.py
:description This pattern aims to minimise the number of objects that are needed by
