"""
:testcase_name: pool
:source https://github.com/faif/python-patterns/blob/master/patterns/creational/pool.py
:description This pattern is used when creating an object is costly (and they are
